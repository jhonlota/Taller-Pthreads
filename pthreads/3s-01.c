...
void *count3s_thread(void *arg) {
    ...
    //Este punto nos genera una duda
    //el valor que genera debe ser diferente de cero (0) para decir que fue valido. 
    //¿Donde se comprueba si hubo o no error al crear el hilo?
}
